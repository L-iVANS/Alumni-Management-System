<?php
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['log_username']) && isset($_POST['log_password'])) {
        ...
        $sql = "INSERT INTO alumni SET fname='$fname', mname='$mname', lname='$lname', course='$course', batch_startYear='$fromYear', batch_endYear='$toYear', connected_to='$connected_to', contact='$contact', address='$address', email='$email', username='$username', password='$password', picture='$imageDataEscaped'";
