                ...
                <div class="container-fluid" id="container-main">
                    <div class="row">
                            ...
                            <div class="container-fluid" id="content-container">
                                <div class="information">
                                    <form>
                                        <fieldset disabled>
                                            <div class="mb-3">
                                                    <label for="disabledTextInput" class="form-label">COORDINATORS FULL NAME</label>
                                                    <input fname="coordinatorsfullname" id="disabledTextInput" class="form-control" placeholder="First name" value="<?php echo htmlspecialchars("$fname $mname $lname"); ?>" />
                                                </div>
                                                    <div class="mb-3">
                        ...
                        <div class="row">
                            <div class="container-fluid">
                                <div class="buttons">
                                    <a href="./update_info.php"><button type="button" class="btn" id="button1">UPDATE INFO</button></a>
