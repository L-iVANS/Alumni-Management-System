        ...
        <div class="side-content">
            ...
            <div class="side-menu">
                <ul>
                    ...
                    <li>
                        <a href="./alumni_archive.php" class="active">
                        ...
                        <div class="row">
                            ...
                            <div class="col">
                                <div class="add-button" style="margin-left: 20%; margin-right: 0;">
                                        <a class='btn btn-secondary border border-dark' href='./alumni_archive.php' style="padding-left: 55px; padding-right: 55px; margin-right: 1%;">Alumni</a>
