<?php 
    ...
    $sql_restore = "INSERT INTO coordinator (coor_id, name, contact, email, username, password, picture, date_created)" . 
                   "SELECT coor_id, name, contact, email, username, password, picture, date_created FROM coordinator_archive WHERE coor_id=$coor_id";
